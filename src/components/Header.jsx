			...
			<ul className="w-screen px-4 py-2 flex font-medium justify-between bg-white items-center fixed top-0 z-50 shadow-lg">
				...
				<div className="relative" ref={menuRef}>
                    <div className="flex gap-4">
                        ...
                        <Link to="/register" className="flex items-center gap-2 px-4 py-2 bg-slate-950 text-white hover:bg-slate-800 rounded-md cursor-pointer border-2 border-slate-900">
                            Register
                        </Link>
                    </div>
